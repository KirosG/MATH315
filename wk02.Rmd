...
##### Assignments
* Research question assignment [[Instructions]](hw/personal_codebook_assignment.html) (Due 9/3)
...
##### Assignments
* Citation assignment [[Instructions]](hw/citation_assignment.html) [[RMD Template]](hw/citation_assignment_template.Rmd)(Due 9/10)
    - [Example assignment](docs/Citation Assignment Example.pdf)
* Data Camp: Intro to ggplot (first chapter only) & corresponding BBL Quiz (Due 9/5)
