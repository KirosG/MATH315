...
##### How to submit
* Upload your work as a **WORD** or **PDF** document to Blackboard by the due date. 
    - If you are comfortable with taking screen shots, saving them to your computer and using Rmarkdown to insert images then I recommend you create complete this assignment as a `.MD` or `.RMD` file. 
