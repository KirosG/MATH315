...
So you display a graph, then a table, then words to describe that distribution. Then a graph, a table, paragraph etc. 
...
* Knit your file to **HTML** and submit to BBLearn by the deadline.
* You will review 2 other team graphics as a separate assignment. See [project page](https://norcalbiostat.github.io/MATH315/project.html) for details and links. 
 
 
## Instructions

1. Go through your variables and make sure that you know what variables are categorical and what are quantitative.
2. Write a short summary paragraph as an intro letting the reader know what this post is about and what variables you are exploring. 
...
4. Complete describe at least 2 of your quantitative variables. 
    - If you DO NOT have truly quantitative variables, then consider if the quantitative variable age or some other quantitative variable(s) would be a variable(s) to include. 
