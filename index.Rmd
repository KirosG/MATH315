...
* Supplemental Info for Final Exam [[OFFICIAL]](https://norcalbiostat.github.io/MATH615/FinalDocs/FinalExam_Fall17_Supplemental.pdf). This document consists of a summary of the survey, data management, univariate descriptions for variables used, and a few pages of analysis. 
* Print these pages. Ensure that you understand what models are being fit and how to read the output. You are allowed to write notes on these pages. Bring them to the final. 
