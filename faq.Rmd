...
* Butte 211 has an open computer lab. R & R studio are not installed, but you can install it as
...
* The only question I do not understand about the course is the way that the notes are structured, am I suppost to answer all the questions on the notes or is it only the designated Q section. 
